...
class LocationPersonRecyclerViewAdapter(private val persons: List<Person>) :
    RecyclerView.Adapter<LocationPersonRecyclerViewAdapter.LocationPersonRecyclerViewHolder>() {
    class LocationPersonRecyclerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LocationPersonRecyclerViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.person_item, parent, false)
        return LocationPersonRecyclerViewHolder(view)
    }

    override fun onBindViewHolder(
        holder: LocationPersonRecyclerViewHolder,
        position: Int
    ) {
